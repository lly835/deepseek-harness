...
export const en = {
  ...
  modelReasoningHint: 'Select the levels this model offers and, when needed, edit the value sent on the wire.',
  modelReasoningLevel: 'Reasoning level',
  modelReasoningWire: 'Wire value',
  modelReasoningOffWire: 'Leave empty to omit the effort value',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoning: '思考档位',
  modelReasoningHint: '选择该模型提供的思考档位；如提供方使用不同参数值，可修改实际发送的协议值。',
  modelReasoningLevel: '思考档位',
  modelReasoningWire: '协议值',
  modelReasoningOffWire: '留空表示不发送档位参数',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
